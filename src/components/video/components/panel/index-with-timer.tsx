  ...
  return (
    ...
    >
      ...
      >
        ...
        <Flex justify="space-between" className={styles.barContent}>
          <Space align="center">
            <div className={styles.pauseIcon} onClick={handleTogglePlay}>
              <Icon>{isPause ? <PlayIcon /> : <PauseIcon className={styles.icon} />}</Icon>
            </div>
          ...
          <Space align="center" size="large">
            ...
            <div className={styles.icon} onClick={onToggleFull}>
